...
// ----------------------------------------------------------
// mouseCallback() Callback function
// ----------------------------------------------------------
void mouseCallback(GLFWwindow *window, double x, double y)
{
...
void display(GLFWwindow* window){
  ...
  //Draw only the hangar floor (no shadow generated by floor)
...
int main(int argc, char* argv[]){
  ...
  //Set up camera
  camera = new Camera(640,16,250,200,15,false);
...
//Source -> https://vallentin.io/2014/02/07/glfw-center-window
void centerWindow(GLFWwindow *window, GLFWmonitor *monitor)
{
  if (!monitor)
    return;
...
//Puts raster pixel text labels above planes
void drawLabels(){
  glRasterPos3d(112,30,412);
  Print("MQ-9 Reaper");
  glRasterPos3d(637.5,35,112.5);
  Print("F-16 Fighting Falcon");
